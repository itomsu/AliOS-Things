src =Split('''
    ...
    Src/usb_otg.c
''')
component =aos_board_component('pai011', 'stm32l4xx_cube', src)
...
aos_global_config.set('CONFIG_SYSINFO_PRODUCT_MODEL', 'ALI_AOS_pai011')
aos_global_config.set('CONFIG_SYSINFO_DEVICE_NAME','pai011')
...
component.add_global_macros('SYSINFO_PRODUCT_MODEL=\\"'+'ALI_AOS_pai011'+'\\"')
component.add_global_macros('SYSINFO_DEVICE_NAME=\\"'+'pai011'+'\\"')
